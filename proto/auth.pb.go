...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\x0eForgotPassword\x12\x12.auth.LoginRequest\x1a\x1c.auth.ForgotPasswordResponseBFZDgithub.com/ariefzainuri96/go-api-ecommerce-auth-service/proto;authpbb\x06proto3"
...
var file_proto_auth_proto_depIdxs = []int32{
	...
	2, // 2: auth.AuthService.ForgotPassword:input_type -> auth.LoginRequest
	1, // 3: auth.AuthService.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.AuthService.Login:output_type -> auth.LoginResponse
	4, // 5: auth.AuthService.ForgotPassword:output_type -> auth.ForgotPasswordResponse
